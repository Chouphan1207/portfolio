...
const MagicButton = ({
  ...
  return (
    <button
      onClick={handleClick}
      className={`relative flex-col inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 ${otherClasses}`}
    >
