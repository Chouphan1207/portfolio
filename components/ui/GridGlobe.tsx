...
export function Globe() {
  ...
  const colors = ["#a6e1fa", "#00072d", "#0a2472"];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    <div className="flex items-center justify-center absolute -left-1 mt-5 top-10 md:top-20 w-full h-full scale-130">
      ...
      <div className="absolute w-full bottom-0 inset-x-0 bg-gradient-to-b pointer-events-none select-none from-transparent dark:to-black to-white h-40 z-50 y-40" />
        ...
        <div className="absolute w-full h-89 w-10 md:h-full">
